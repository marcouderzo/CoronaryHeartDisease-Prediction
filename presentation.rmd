...
Overall, we'll see through the Analysis of Deviance that the removal of such predictors from the model does not yield significantly worse performance.
...
lasso.auc <- model.plot.roc(y_pred, test$HeartDisease)
lasso.auc
...
ridge.auc <- model.plot.roc(y_pred, test$HeartDisease)
ridge.auc
```
...
glm.model.4.auc <- glm.model.4.auc[[1]]
